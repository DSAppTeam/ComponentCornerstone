...
class Utils {
     ...
     * @return
     */
    static String parseMainModuleName(@Nonnull Project project, @Nonnull com.plugin.module.alone.AssembleTask assembleTask) {
    ...
    static com.plugin.module.alone.AssembleTask parseTaskInfo(@Nonnull List<String> taskNames) {
        com.plugin.module.alone.AssembleTask assembleTask = new com.plugin.module.alone.AssembleTask()
        if (!taskNames.isEmpty()) {
            for (String task : taskNames) {
                buildOutput("task(" + task + ")");
                if (task.toUpperCase().contains("ASSEMBLE")
                    ...
                    buildOutput("task is debug (" + assembleTask.isDebug + ")");
     ...
     * @param project
     */
    static void compileComponents(@Nonnull Project project, @Nonnull com.plugin.module.alone.AssembleTask assembleTask) {
        String components;
